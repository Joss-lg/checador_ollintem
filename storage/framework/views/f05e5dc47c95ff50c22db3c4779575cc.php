...
<table class="summary-table">
    <tr>
        <td>
            ...
            <div class="summary-value"><?php echo e($resumen['jornadas']); ?></div>
        </td>
        <td>
            <div class="summary-title">Tiempo trabajado</div>
            <div class="summary-value"><?php echo e($resumen['horas_trabajadas']); ?></div>
        </td>
        <td>
            <div class="summary-title">Pausas</div>
            <div class="summary-value"><?php echo e($resumen['tiempo_pausa']); ?></div>
        </td>
    </tr>
</table>
...
<div class="footer">
    OllinCheck | Generado: <?php echo e(now()->format('d/m/Y H:i')); ?>
